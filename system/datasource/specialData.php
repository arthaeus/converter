<?php
	...
	abstract class specialData extends abstractDatasourceBase implements iDatasource
	{
    ...
    public function getIMls()         { return $this->getContainer(); }
		...
		public function perform()
		{
			 ...
			 * close the file
			 */
			$procDoneMessage = "done with glob processing for " . $this->getIMls()->getCadID() . " images." ;
      /**
